...
- Spawn timers for fish and cars
...
**Key Methods**:
- `new()` - Spawn from random edge
- `update(&self, assets)` - Update position and render
...
- Car collision: Cat collides with Car → exit game
